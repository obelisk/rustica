...
pub fn build_force_command(hosts: &Vec<String>, force_command: Option<String>) -> Result<String, RusticaServerError> {
    ...
    force_command.push_str(&format!("export FORCE_COMMAND={};", force_command));
